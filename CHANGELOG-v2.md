...
## OPEB series + copy pass (July 10, 2026)
- **OPEB by year added** (user-supplied from ACFR OPEB notes, FY2018-2025, $ thousands): 1,255,027 / 1,129,106 / 1,228,417 / 1,383,998 / 1,312,274 / 1,181,609 / 1,169,314 / 1,237,486. Decoder's "$1.2B unfunded retiree healthcare" glance card now has a 2018→2025 sparkline; data-sources gained an 8th tracked series row (id ind-opeb) with sparkline + full values; CSV/JSON gained a total_opeb_liability column. FY2017's ~$2.54B figure is GASB 45 basis (not comparable) and is footnoted, not charted.
